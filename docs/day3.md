# Day 3 (Jan 6th): Neural Network Models for Regression
...
The workshop follows a **flipped-classroom** structure, so participants should watch the videos and review the materials ***before*** Jan 6th.
